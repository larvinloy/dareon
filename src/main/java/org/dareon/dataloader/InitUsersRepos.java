...
public class InitUsersRepos
{
    ...
    /**
     * 
     * @param roleRepository2 details the roleRepository for defining roles of different users
     * @param userRepository2 details the userRepository to define difeerent types of users who have access to website
     * @param repoRepository2 details the repoRepositories to explain user and roles related to particulars repositories thus created in the system
     * @param cfpRepository2  details the cfpRepository to explain user and roles related to particular cfp
     * @param proposalRepository2 details the proposalRepository to explain user and roles related to particular proposal.
     */
